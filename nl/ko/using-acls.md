...
ACL을 효과적으로 만들기 위해 인바운드 및 아웃바운드 네트워크 트래픽을 처리하는 방법을 판별하는 규칙을 작성합니다. 다중 인바운드 및 아웃바운드 규칙을 작성할 수 있습니다. 작성할 수 있는 규칙 수에 대한 특정 정보는 [할당량](https://{DomainName}/docs/infrastructure/vpc?topic=vpc-quotas)을 참조하십시오. 
