...
## 手順の例
リモートの Juniper vSRX ピアに接続するためのトポロジーは、[2 つの VPC 間に VPN 接続を作成](/docs/infrastructure/vpc-network?topic=vpc-network--beta-using-vpn-with-your-vpc)するのと似ています。ただし、接続の一方の側が Juniper vSRX ユニットに置き換わっている点が異なります。
